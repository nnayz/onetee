...
export const CommunityAPI = {
  ...
  followUser: (targetUserId: string) => api.post(`/community/users/${targetUserId}/follow`).then((r) => r.data),
  unfollowUser: (targetUserId: string) => api.post(`/community/users/${targetUserId}/unfollow`).then((r) => r.data),
  ...
  whoToFollow: () => api.get(`/community/suggestions/who-to-follow`).then((r) => r.data),
